...
function initPageSwitch() {
    const goMultiPageBtn = document.getElementById("goMultiPage");
    const backToMainBtn = document.getElementById("backToMain");

    if (!goMultiPageBtn || !backToMainBtn) {
        console.error("页面切换按钮未找到，请检查 HTML ID 是否正确");
        return;
    }

    goMultiPageBtn.addEventListener("click", () => {
