        ...
        class LotterySystem {
            ...
            getProject3HTML() {
                return `<div class="filter-group"><div class="filter-title">1. 大小形态：小 0-4  >< 大 5-9</div><div class="filter-options" data-type="size"><div class="filter-option active" data-value="all">全部不选</div><div class="filter-option" data-value="all-big">全大</div><div class="filter-option" data-value="all-small">全小</div><div class="filter-option" data-value="2big1small">2大1小</div><div class="filter-option" data-value="2small1big">2小1大</div></div></div><div class="filter-group"><div class="filter-title">2. 奇偶形态：奇 1 3 5 7 9 >< 偶 0 2 4 6 8</div><div class="filter-options" data-type="parity"><div class="filter-option active" data-value="all">全部不选</div><div class="filter-option" data-value="all-odd">全奇</div><div class="filter-option" data-value="all-even">全偶</div><div class="filter-option" data-value="2odd1even">2奇1偶</div><div class="filter-option" data-value="2even1odd">2偶1奇</div></div></div><div class="filter-group"><div class="filter-title">3. 质合形态：质 2 3 5 7  >< 合 0 1 4 6 8 9</div><div class="filter-options" data-type="prime"><div class="filter-option active" data-value="all">全部不选</div><div class="filter-option" data-value="all-prime">全质</div><div class="filter-option" data-value="all-composite">全合</div><div class="filter-option" data-value="2prime1composite">2质1合</div><div class="filter-option" data-value="2composite1prime">2合1质</div></div></div><div class="filter-group"><div class="filter-title">4. 重号条件</div><div class="filter-options" data-type="repeat"><div class="filter-option active" data-value="all">全部不选</div><div class="filter-option" data-value="has-repeat">有重号</div><div class="filter-option" data-value="no-repeat">无重号</div></div></div><div class="filter-group"><div class="filter-title">5. 跨度范围</div><div class="filter-options" data-type="span"><div class="filter-option active" data-value="all">全部不选</div><div class="filter-option" data-value="small">小跨度(0-4)</div><div class="filter-option" data-value="medium">中跨度(5-7)</div><div class="filter-option" data-value="large">大跨度(8-9)</div></div></div><div class="filter-group"><div class="filter-title">6. 和值范围</div><div class="filter-options" data-type="sum"><div class="filter-option active" data-value="all">全部不选</div><div class="filter-option" data-value="small">小和值(0-13)</div><div class="filter-option" data-value="medium">中和值(14-20)</div><div class="filter-option" data-value="large">大和值(21-27)</div></div></div><div class="kill-panel"><div class="filter-title">7. 杀码范围 (绿色选择，红色排除)</div><div class="kill-balls" id="killBalls">${Array.from({length: 10}, (_, i) => `<div class="kill-ball include" data-number="${i}">${i}</div>`).join('')}</div></div><div class="position-panel"><div class="filter-title">8. 定位选择 (点亮球体表示选中)</div><div class="position-row"><div class="position-label">百位：</div><div class="position-balls" data-position="hundred">${Array.from({length: 10}, (_, i) => `<div class="pos-ball" data-number="${i}">${i}</div>`).join('')}</div></div><div class="position-row"><div class="position-label">十位：</div><div class="position-balls" data-position="ten">${Array.from({length: 10}, (_, i) => `<div class="pos-ball" data-number="${i}">${i}</div>`).join('')}</div></div><div class="position-row"><div class="position-label">个位：</div><div class="position-balls" data-position="unit">${Array.from({length: 10}, (_, i) => `<div class="pos-ball" data-number="${i}">${i}</div>`).join('')}</div></div></div><div class="action-buttons"><button class="action-btn clear-btn" id="clearFilterBtn"><i class="fas fa-eraser"></i>一键清除</button><button class="action-btn" id="showGridBtn" style="background: linear-gradient(145deg, #9b59b6, #8e44ad); color: #000000; box-shadow: 0 6px 0 #ffffff;"><i class="fas fa-copy"></i>显示网格号码</button></div><div class="result-stats"><div class="result-stat"><div class="result-value" id="totalRecommendations">0</div><div class="result-label">推荐号码</div></div><div class="result-stat"><div class="result-value" id="filterCount">0</div><div class="result-label">过滤条件</div></div><div class="result-stat"><div class="result-value" id="killCount">0</div><div class="result-label">杀码数量</div></div><div class="result-stat"><div class="result-value" id="positionCount">0</div><div class="result-label">定位选择</div></div></div><div class="table-wrapper result-table"><table class="num-table"><thead><tr>${Array.from({length: 10}, (_, i) => `<th>${i}</th>`).join('')}</tr></thead><tbody id="project3Results"></tbody></table></div>`;
            }
